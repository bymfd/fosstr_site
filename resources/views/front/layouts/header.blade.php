...
<head>
    ...
    <meta name="description" content="Özgür ve açık kaynaklı yazılımlar, topluluklar ve şirketleri tanımanıza yardımcı oluyoruz.">
    <meta name="author" content="fosstr.com">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-VSS9KPGCLD"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-VSS9KPGCLD');
    </script>
...
<header class="masthead" style="background-image: url('@yield('bg',asset('front/img/bg.png'))')">
